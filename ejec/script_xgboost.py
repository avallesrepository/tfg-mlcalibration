...
output_dir = "calibration_results_xgboost_med"
os.makedirs(output_dir, exist_ok=True)

# Carga de datasets
dataset_ids = [310, 725, 761, 803, 807, 819, 833, 847, 923, 959, 1019, 1046, 1053, 1471, 1489, 4154, 4534, 41526, 45023, 45036, 46281, 46298]
...
for dataset_id in dataset_ids:
    ...
    for repetition in range(n_repeats):
        ...
        for train_idx, test_idx in skf.split(X, y):
            ...
            clf = XGBClassifier(n_estimators=100, learning_rate=0.1, max_depth=6, use_label_encoder=False, random_state=42, eval_metric="logloss")
